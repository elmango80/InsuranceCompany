namespace MNG.Domain.Values
{
    public static class MessageValues
    {
        ...
        public static string CLIENTS_REPOSITORY_EMPTY 
        { 
            get => "No data has been obtained from the clients repository.";
        }

        public static string POLICIES_REPOSITORY_EMPTY
        {
            get => "No data has been obtained from the policies repository.";
        }
    }
}
